...
# # How to Do Deep Learning on Graphs with Graph Convolutional Networks ## Part 2: Semi-Supervised Learning with
# Spectral Graph Convolutions This notebook accompanies my Medium article with the above title for readers to try out
# and explore graph convolutional networks for themselves. You can find the article [here](
# https://towardsdatascience.com/how-to-do-deep-learning-on-graphs-with-graph-convolutional-networks-62acf5b143d0).
# To run the notebook, install the packages specified in the accompanying requirements.txt file.
